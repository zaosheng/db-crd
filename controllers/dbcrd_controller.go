...
// +kubebuilder:rbac:groups=apps.unicom.cn,resources=dbcrds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apps.unicom.cn,resources=dbcrds/status,verbs=get;update;patch
func (r *DBcrdReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	fmt.Println("---start Reconcile---")
	ctx := context.Background()
	lgr := r.Log.WithValues("dbcrd", req.NamespacedName)
